...
Entitys:
  - Entity: 8189606469567907201
    ...
    TransformComponent:
      ...
      Rotation: [0, 0, 0.747759998]
      Scalation: [11.2980471, 0.99999994, 1]
  ...
  - Entity: 2521038104214275109
    ...
    TransformComponent:
      ...
      Scalation: [1.04029989, 1.04029989, 1.04030001]
    SpriteRendererComponent:
      Color: [1, 1, 1, 1]
      Texture: none
      TilingFactor: 1
    ScriptComponent:
      Name: Sandbox.Player1
    RigidBody2DComponent:
      Type: Dynamic
      FixedRotation: false
    BoxCollider2DComponent:
  ...
  - Entity: 3341696091676390481
    ...
    TransformComponent:
      ...
      Rotation: [0, 0, -0.584609866]
      Scalation: [9.42679024, 0.523697376, 1]
    SpriteRendererComponent:
      Color: [0, 1, 0, 1]
      Texture: none
      TilingFactor: 1
